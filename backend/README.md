...
## Project Structure
    ...
    ├── testapiautostorybo_109403  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_109403`
...
2. Clone this repo and `cd testapiautostorybo_109403`
